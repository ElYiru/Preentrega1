      ...
      <nav className="bg-gray-800">
        ...
        <div className="sm:hidden" id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            ...
            <Link to="/equipo" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Equipo</Link>
            <Link to="/proyectos" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Proyectos</Link>
            <Link to="/calendario" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Calendario</Link>
          </div>
        </div>
      </nav>
    </>
